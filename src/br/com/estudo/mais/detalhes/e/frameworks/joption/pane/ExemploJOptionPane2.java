...
public class ExemploJOptionPane2 {
	...
	public static void main(String[] args) throws Exception {
		...
		URL url = ExemploJOptionPane1.class.getResource("rmconsultoria.jpg");
		Icon icone = new ImageIcon(url);
		
		JOptionPane.showMessageDialog(null, "Obrigado por escolher a RM Consultoria", "RM Consultoria", JOptionPane.INFORMATION_MESSAGE, icone);
