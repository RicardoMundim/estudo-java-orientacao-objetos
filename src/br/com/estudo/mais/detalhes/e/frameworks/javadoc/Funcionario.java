package br.com.estudo.mais.detalhes.e.frameworks.javadoc;
...
public class Funcionario {
		...
		/**
		 * Não utilize mais, pois o argumento salário é obrigatório para outros metodos
		 * 
		 * @param nome
		 */
		 ...
		 * 
		 * @param 	dias
		 * 			Quantidade da duração em dias da viagem
		 * 
		 * @param 	capital
