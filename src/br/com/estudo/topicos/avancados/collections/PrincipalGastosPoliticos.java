...
public class PrincipalGastosPoliticos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Gastos com vereadores do partido LDRS: " + formatador.format(gastosVereadoresLdrs.doubleValue()));
		...
		BigDecimal gastosPrefeitosPcor = governo.calcularGastosComSalarioParaCargo(prefeito, "PCOR");
		System.out.println(
				"Gastos com prefeitos do partido PCOR: " + formatador.format(gastosPrefeitosPcor.doubleValue()));
	}
}
