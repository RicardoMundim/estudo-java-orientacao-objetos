...
public class CalculadoraGravidez {
	...
	public Date calcularDataEstimadaParto() {
		Calendar dataEstimadaDoParto = this.converterDateParaCalendar(this.dataUltimoPeriodoMenstrual);
		dataEstimadaDoParto.add(Calendar.WEEK_OF_YEAR, 40);
		
		return dataEstimadaDoParto.getTime();
	}
